...
urlpatterns = [
    ...
    path('api/v1/draft/live/<int:year>/<str:season>/<str:draft_type>/', views.api.draft_api),
    ...
    path('draft/live/<int:year>/<str:season>/<str:draft_type>/edit/', views.site.draft_admin),
    path('draft/live/<int:year>/<str:season>/<str:draft_type>/', views.site.draft_watch),
