...
def roster_team_detail(request, abbreviation):
    ...
    context['mlb_roster'] = team_players.filter(is_mlb_roster=True, is_carded=True, , is_aaa_roster=False, is_carded=True, is_1h_c=False, is_1h_p=False, is_1h_pos=False, is_reserve=False).order_by('position', '-level_order', 'last_name')
    context['num_mlb'] = context['mlb_roster'].count()
    context['aaa_roster'] = team_players.filter(is_aaa_roster=True, is_carded=True, , is_aaa_roster=False, is_carded=True, is_1h_c=False, is_1h_p=False, is_1h_pos=False, is_reserve=False).order_by('position', '-level_order', 'last_name')
