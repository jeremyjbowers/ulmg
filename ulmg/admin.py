...
class DraftPickAdmin(admin.ModelAdmin):
    ...
    search_fields = ['player__name', 'team__city', 'team__abbreviation', 'slug', 'year', 'season', 'draft_type']
    fieldsets = (
        (None, {
            'fields': (
                ('year','slug','season'),
...
class PlayerAdmin(admin.ModelAdmin):
    model = Player
    list_display = ["last_name", "first_name", "is_owned", "team", 'birthdate', 'is_amateur', 'fg_id', 'league', 'ls_is_mlb', 'level', 'is_mlb_roster']
