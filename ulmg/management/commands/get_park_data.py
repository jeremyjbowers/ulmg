...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        for year in years_range:
            ...
            raw_data = soup.select('div.article-template')[0].select('script')[0].text.split(';')[0].split('var data =')[1].split('var')[0].strip()
            ...
            for park in parsed_data:
                ...
                if not os.path.exists(filename):
                    park['venue_url'] = f"https://baseballsavant.mlb.com/leaderboard/statcast-venue?venueId={park['venue_id']}"
